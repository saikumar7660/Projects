...
public class App {
    ...
    public static void main(String[] args) throws DuplicateSymbolException, PlayerCountMismatchException, MoreThanOneBotException {
        ...
        playerList.add(new Player('X', "Sai", 1, PlayerType.HUMAN));
        ...
        // let's keep on printing the board and making the move  till the game is in progress

        while(game.getGameState().equals(GameState.IN_PROGRESS)){


            game.printBoard();
            System.out.println("Do you want to undo previous player's Move:(Y/N)");
        ...
        // if I reached here, it means the game is NOT in progress

        if(GameState.SUCCESS.equals(game.getGameState()))
        {
            System.out.println(game.getWinner().getName()+", Congrats! You have won the Game:");
        }
